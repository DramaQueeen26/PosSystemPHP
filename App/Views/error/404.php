                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <h5 class="error-details">
                            Ha ocurrido un error, la página no ha sido encontrada.
                        </h5>
                        <div class="text-center">
                            <a class="btn btn-secondary mt-5 mb-5" href="<?=$baseUrl?>"> <i class="fa fa-long-arrow-left"></i> Regresa a inicio </a>
                        </div>
                    </div>
                </div>
            </div>
